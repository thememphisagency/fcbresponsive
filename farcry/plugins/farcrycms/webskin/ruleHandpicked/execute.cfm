...
<cfif arrayLen(stobj.aPickedObjects)>
	<cfloop from="1" to="#arrayLen(stobj.aPickedObjects)#" index="i">
		<cfset viewObjectid = stobj.aPickedObjects[i].data />
		<cfif request.mode.showdraft>
			<q4:contentobjectget objectid="#stobj.aPickedObjects[i].data#" r_stobject="stObject">
		...
		<skin:view objectID="#viewObjectid#" typename="#stobj.aPickedObjects[i].typename#" webskin="#stobj.aPickedObjects[i].webskin#" alternateHTML="<p>WEBSKIN NOT AVAILABLE</p>" />
