<cfcomponent displayname="Forms Configuration" hint="Website Forms Configuration" extends="farcry.core.packages.forms.forms" output="false" key="fcbForms">
	...
	<cfproperty ftSeq="3" ftFieldset="" name="enquiryFromEmail" type="String" default="log@thememphisagency.com" hint="" ftLabel="From Email" />
	<cfproperty ftSeq="4" ftFieldset="" name="enquiryFromName" type="String" default="TMA Support" hint="" ftLabel="From Name" />
	<cfproperty ftSeq="5" ftFieldset="" name="enquiryRecipient" type="String" default="log@thememphisagency.com" hint="" ftLabel="Recipient Email" />
